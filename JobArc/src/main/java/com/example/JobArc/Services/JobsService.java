...
public class JobsService implements IJobsService{
    ...
    @Override
    public DashboardResponse getEmployerDashboard(JobRepository jobRepository, JobMappingRepository jobMappingRepository, User user){
    ...
    @Override
    public DashboardResponse getJobseekerDashboard(JobRepository jobRepository, JobMappingRepository jobMappingRepository){
        List<Job> jobs = jobRepository.findRecentJobs();
        return new DashboardResponse(jobs);
    }

    @Override
    public Status createNewJob(JobRepository jobRepository, JobMappingRepository jobMappingRepository, User employer, JobRequest newJob){
    ...
    @Override
    public Job getJobById(JobRepository jobRepository, JobMappingRepository jobMappingRepository, long id){
    ...
    @Override
    public ApplicantJobsResponse getJobsByIds(JobRepository jobRepository, JobMappingRepository jobMappingRepository, List<Long> jobIds){
        List<Job> jobs = jobRepository.findAllById(jobIds);
        return new ApplicantJobsResponse(jobs);
    }

    @Override
    public ApplicantJobsResponse searchJobs(JobRepository jobRepository, JobMappingRepository jobMappingRepository, String keyword){
